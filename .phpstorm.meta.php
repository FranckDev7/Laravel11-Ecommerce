...
'hashing.rehash_on_login','view.paths','view.compiled','image.driver','image.options.autoOrientation',
'image.options.decodeAnimation','image.options.blendingColor','image.options.strip','tinker.commands','tinker.alias',
'tinker.dont_alias',);
        registerArgumentsSet('middleware', 
'web','api',);
        registerArgumentsSet('routes', 'login','logout','register','password.request','password.email','password.reset','password.update',
'password.confirm','home.index','shop.index','shop.product.details',
'cart.index','user.index','admin.index','admin.brands','admin.brand.add',
'admin.brand.store','admin.brand.edit','admin.brand.update','admin.brand.delete','admin.categories',
'admin.category.add','admin.category.store','admin.category.edit','admin.category.update','admin.category.delete',
'admin.products','admin.product.add','admin.product.store','admin.product.edit','admin.product.update',
'admin.product.delete','storage.local',);
        registerArgumentsSet('views', 
'admin.brand-add','admin.brand-edit','admin.brands','admin.categories','admin.category-add',
'admin.category-edit','admin.index','admin.product-add','admin.product-edit','admin.products',
'auth.login','auth.passwords.confirm','auth.passwords.email','auth.passwords.reset','auth.register',
'auth.verify','cart','details','home','index',
'layouts.admin','layouts.app','shop','user.account-nav','user.index',
...
'DB_USERNAME','DB_PASSWORD','DB_COLLATION','SESSION_DRIVER','SESSION_LIFETIME',
