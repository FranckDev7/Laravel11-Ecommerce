    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'cart' => \Surfsidemedia\Shoppingcart\Cart::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\laravel11-Ecommerce\public\storage' => 'string',
...
'cache.prefix','cart.tax','cart.database.connection','cart.database.table','cart.destroy_on_logout',
'cart.format.decimals','cart.format.decimal_point','cart.format.thousand_seperator','database.default','database.connections.sqlite.driver',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\laravel11-Ecommerce\\public\\storage','ide-helper.filename',
...
'logging.channels.null.handler','logging.channels.emergency.path','logviewer.max_file_size','logviewer.pattern','logviewer.storage_path',
...
'password.update','password.confirm','home.index',
'shop.index','shop.product.details','cart.index','cart.add','cart.qty.increase',
'cart.qty.decrease','cart.item.remove','cart.empty','cart.coupon.apply','cart.coupon.remove',
'wishlist.add','wishlist.index','wishlist.item.remove','wishlist.items.clear','wishlist.move.to.cart',
'user.index','admin.index','admin.brands','admin.brand.add','admin.brand.store',
'admin.brand.edit','admin.brand.update','admin.brand.delete','admin.categories','admin.category.add',
'admin.category.store','admin.category.edit','admin.category.update','admin.category.delete','admin.products',
'admin.product.add','admin.product.store','admin.product.edit','admin.product.update','admin.product.delete',
'admin.coupons','admin.coupon.add','admin.coupon.store','admin.coupon.edit','admin.coupon.update',
'admin.coupon.delete','storage.local',);
        registerArgumentsSet('views', 
'admin.brand-add','admin.brand-edit','admin.brands','admin.categories','admin.category-add',
'admin.category-edit','admin.coupon-add','admin.coupon-edit','admin.coupons','admin.index',
'admin.product-add','admin.product-edit','admin.products','auth.login','auth.passwords.confirm',
'auth.passwords.email','auth.passwords.reset','auth.register','auth.verify','cart',
'details','home','index','laravel-log-viewer::log','layouts.admin',
'layouts.app','modal-cart','modal-wishlist','shop','user.account-nav',
'user.index','vendor.laravel-log-viewer.log','welcome','wishlist','laravel-exceptions-renderer::components.card',
...
'laravel-exceptions::500','laravel-exceptions::503','laravel-exceptions::layout','laravel-exceptions::minimal','laravel-log-viewer::log',
...
'validation.uuid','validation.custom.attribute-name.rule-name','fr.0','actions.accept','actions.action',
'actions.actions','actions.add','actions.admin','actions.agree','actions.archive',
'actions.assign','actions.associate','actions.attach','actions.browse','actions.cancel',
'actions.choose','actions.choose_file','actions.choose_image','actions.click_to_copy','actions.close',
'actions.collapse','actions.collapse_all','actions.comment','actions.confirm','actions.connect',
'actions.create','actions.delete','actions.detach','actions.details','actions.disable',
'actions.discard','actions.done','actions.down','actions.duplicate','actions.edit',
'actions.enable','actions.expand','actions.expand_all','actions.explanation','actions.export',
'actions.file','actions.files','actions.go_home','actions.hide','actions.home',
'actions.image','actions.impersonate','actions.impersonation','actions.import','actions.introduction',
'actions.like','actions.load','actions.localize','actions.log_in','actions.log_out',
'actions.named.add','actions.named.choose','actions.named.create','actions.named.delete','actions.named.duplicate',
'actions.named.edit','actions.named.export','actions.named.hide','actions.named.import','actions.named.new',
'actions.named.restore','actions.named.save','actions.named.search','actions.named.show','actions.named.update',
'actions.named.view','actions.new','actions.no','actions.open','actions.open_website',
'actions.preview','actions.price','actions.record','actions.restore','actions.save',
'actions.save_and_close','actions.save_and_return','actions.search','actions.select','actions.select_all',
'actions.send','actions.settings','actions.show','actions.show_all','actions.sign_in',
'actions.solve','actions.start','actions.stop','actions.submit','actions.subscribe',
'actions.switch','actions.switch_to_role','actions.tag','actions.tags','actions.target_link.blank',
'actions.target_link.parent','actions.target_link.self','actions.target_link.top','actions.translate','actions.translate_it',
'actions.unpack','actions.unsubscribe','actions.up','actions.update','actions.user',
'actions.view','actions.yes','http-statuses.0','http-statuses.100','http-statuses.101',
...
'DB_DATABASE','DB_USERNAME','DB_PASSWORD','DB_COLLATION','SESSION_DRIVER',
