        ...
        <section class="shop-main container d-flex pt-4 pt-xl-5">
                                        ...
                                        <li class="list-item">
                                            <span class="menu-link py-1">
                                                <input
                                                    ...
                                                    name="categories[]"
                                                    value="{{ $category->id }}"
                                                    @checked(isset($f_categories) && in_array($category->id, explode(',', $f_categories ?? ''))) />
                                                {{ $category->name }}
                                            </span>
                                            <span class="text-right float-end">{{ $category->products ? $category->products->count() : "pas de relation" }}</span>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
                            ...
                            <li class="list-item">
                                <span class="menu-link py-1">
                                    <input
                                        ...
                                        value="{{ $brand->id }}"
                                        class="chk-brand"
                                        @checked(isset($f_brands) && in_array($brand->id, explode(',', $f_brands ?? ''))) >
                                    {{ $brand->name }}
                                </span>
            ...
            <div class="shop-list flex-grow-1">
                ...
                <div class="breadcrumb mb-0 d-none d-md-block flex-grow-1">
                    <a href="{{ route('home.index') }}" class="menu-link menu-link_us-s text-uppercase fw-medium">Accueil</a>
                    <span class="breadcrumb-separator menu-link fw-medium ps-1 pe-1">/</span>
                    <a href="#" class="menu-link menu-link_us-s text-uppercase fw-medium">La boutique</a>
                </div>

                <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
                    <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0 me-3"
                        style="padding-right: 25px;"
                        aria-label="taille des pages"
                        name="pagesize"
                        id="pagesize"
                    >
                        <option value="12" {{ $size === 12 ? 'selected' : '' }}>Afficher</option>
                    ...
                    <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0"
                        ...
                        id="orderby"
                    >
                        <option value="-1" {{ $order == -1 ? 'selected' : '' }}>Trier par</option>
                        <option value="1" {{ $order == 1 ? 'selected' : '' }}>Date, Du nouveau à l'ancien</option>
                        <option value="2" {{ $order == 2 ? 'selected' : '' }}>Date, D'ancien au nouveau</option>
                        <option value="3" {{ $order == 3 ? 'selected' : '' }}>Prix, De moins cher au plus cher</option>
                        <option value="4" {{ $order == 4 ? 'selected' : '' }}>Prix, De plus cher au moins cher</option>
                    </select>
                    ...
                    <button class="btn-link btn-link_f d-flex align-items-center ps-0 js-open-aside" data-aside="shopFilter">
                        ...
                        <span class="text-uppercase fw-medium d-inline-block align-middle">filtre</span>
                    </button>
                    </div>
                </div>
                </div>
                                ...
                                <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                                    <div class="pc__img-wrapper">
                                        ...
                                        @if(Cart::instance('cart')->content()->where('id', $product->id)->count() > 0)
                                            <a href="{{ route('cart.index') }}" class="pc__atc btn btn-warning anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium" title="allez au panier">
                                                <i class="bi bi-cart-check-fill"></i> ALLEZ AU PANIER
                                            </a>
                                        @else
                                        <form name="addtocart-form" method="post" action="{{ route('cart.add') }}">
                                            ...
                                            <button type="submit" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium" data-aside="cartDrawer" title="ajouter au panier">
                                                <i class="bi bi-cart-check-fill"></i> AJOUTER AU PANIER
                                            </button>
                                        </form>
                                        @endif
                                    </div>
                    ...
                    <div class="flex items-center justity-between flex-wrap gap10 wgp-pagination">
                        {{-- withQueryString : garde les paramètres GET (comme ?size=12, ?search=shirt, etc.). --}}
