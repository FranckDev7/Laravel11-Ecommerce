        ...
        <div class="mb-md-1 pb-md-3"></div>
            ...
            <div class="row">
                ...
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    ...
                    <a href="#" class="menu-link menu-link_us-s text-uppercase fw-medium">Accueil</a>
                    ...
                    <a href="#" class="text-uppercase fw-medium"><svg width="10" height="10" viewBox="0 0 25 25"
                        ...
                        </svg><span class="menu-link menu-link_us-s">Precedent</span></a>
                    <a href="#" class="text-uppercase fw-medium"><span class="menu-link menu-link_us-s">Suivant</span><svg
                ...
                @if(Cart::instance('cart')->content()->where('id', $product->id)->count() > 0)
                    <a href="{{ route('cart.index') }}" class="btn btn-warning border-0 text-uppercase fw-medium mb-3 shadow-sm">
                ...
                @else
                    <form name="addtocart-form" method="post" action="{{ route('cart.add') }}">
                        ...
                        <button type="submit" class="btn btn-primary btn-addtocart" data-aside="cartDrawer">AJOUTER AU PANIER</button>
                        </div>
                    </form>
                @endif
                    ...
                    @if (Cart::instance('wishlist')->content()->where('id', $product->id)->count() > 0)
                        <form method="POST" action="{{ route('wishlist.item.remove', ['rowId' => Cart::instance('wishlist')->content()->where('id', $product->id)->first()->rowId]) }}" id="frm-remove-item">
                            ...
                            <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist filled-heart" onclick="document.getElementById('frm-remove-item').submit();"><svg width="16" height="16" viewBox="0 0 20 20"
                                ...
                                <use href="#icon_heart" />
                                </svg><span style="text-transform: none"> Supprimer de la liste de souhait</span>
                            </a>
                        </form>
                    @else
                        <form name="addtocart-form" method="post" action="{{ route('wishlist.add') }}" id="wishlist-form">
                            ...
                            <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist" onclick="document.getElementById('wishlist-form').submit();"><svg width="16" height="16" viewBox="0 0 20 20"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <use href="#icon_heart" />
                            </svg><span style="text-transform: none"> Ajouter a la liste de souhait</span></a>
                        </form>
                    @endif
            ...
            <section class="products-carousel container">
                <h2 class="h3 text-uppercase mb-4 pb-xl-2 mb-xl-4"><strong>Produits</strong> similaires</h2>
