  ...
  <main>
          ...
          <div class="overflow-hidden position-relative h-100">
            ...
            <div class="container slideshow-text position-absolute start-50 top-50 translate-middle">
              <h6 class="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3">
                New Arrivals</h6>
              <h2 class="mb-0 h1 fw-normal animate animate_fade animate_btt animate_delay-5">Night Spring</h2>
          ...
          <div class="overflow-hidden position-relative h-100">
            <div class="bottom-0 slideshow-character position-absolute pos_right-center">
              <img loading="lazy" src="{{ asset('assets/images/slideshow-character2.png') }}" width="400" height="690"
                alt="Woman Fashion 2"
                class="w-auto h-auto slideshow-character__img animate animate_fade animate_rtl animate_delay-10" />
            </div>
            <div class="container slideshow-text position-absolute start-50 top-50 translate-middle">
              <h6 class="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3">
                New Arrivals</h6>
    ...
    <div class="container bg-white mw-1620 border-radius-10">
      ...
      <section class="container category-carousel">
        <h2 class="mb-3 text-center section-title pb-xl-2 mb-xl-4">You Might Like</h2>
        ...
        <div class="position-relative">
          <div class="swiper-container js-swiper-slider" data-settings='{
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <img loading="lazy" class="h-auto mb-3 w-100" src="{{ asset('assets/images/home/demo3/category_1.png') }}" width="124"
                  height="124" alt="" />
              ...
              <div class="swiper-slide">
                <img loading="lazy" class="h-auto mb-3 w-100" src="{{ asset('assets/images/home/demo3/category_2.png') }}" width="124"
                  height="124" alt="" />
                <div class="text-center">
              ...
              <div class="swiper-slide">
                <img loading="lazy" class="h-auto mb-3 w-100" src="{{ asset('assets/images/home/demo3/category_3.png') }}" width="124"
                  height="124" alt="" />
                <div class="text-center">
              ...
              <div class="swiper-slide">
                <img loading="lazy" class="h-auto mb-3 w-100" src="{{ asset('assets/images/home/demo3/category_4.png') }}" width="124"
                  height="124" alt="" />
                <div class="text-center">
              ...
              <div class="swiper-slide">
                <img loading="lazy" class="h-auto mb-3 w-100" src="assets/images/home/demo3/category_5.png" width="124"
                  height="124" alt="" />
                <div class="text-center">
              ...
              <div class="swiper-slide">
                <img loading="lazy" class="h-auto mb-3 w-100" src="{{ asset('assets/images/home/demo3/category_6.png') }}" width="124"
                  height="124" alt="" />
                <div class="text-center">
              ...
              <div class="swiper-slide">
                <img loading="lazy" class="h-auto mb-3 w-100" src="{{ asset('assets/images/home/demo3/category_7.png') }}" width="124"
                  height="124" alt="" />
                <div class="text-center">
              ...
              <div class="swiper-slide">
                <img loading="lazy" class="h-auto mb-3 w-100" src="{{ asset('assets/images/home/demo3/category_8.png') }}" width="124"
                  height="124" alt="" />
                <div class="text-center">
      ...
      <section class="container hot-deals">
        <h2 class="mb-3 text-center section-title pb-xl-3 mb-xl-4">Hot Deals</h2>
        <div class="row">
          <div
            ...
            <a href="#" class="mt-3 btn-link default-underline text-uppercase fw-medium">View All</a>
          </div>
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-card product-card_style3">
                    ...
                    <div class="pc__info position-relative">
                      ...
                      <div
                        class="bottom-0 anim_appear-bottom position-absolute start-0 d-none d-sm-flex align-items-center bg-body">
                        ...
                        <button class="bg-transparent border-0 pc__btn-wl js-add-wishlist" title="Add To Wishlist">
      ...
      <section class="container products-grid">
        <h2 class="mb-3 text-center section-title pb-xl-3 mb-xl-4">Featured Products</h2>

        <div class="row">
          <div class="col-6 col-md-4 col-lg-3">
            <div class="mb-3 product-card product-card_style3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <a href="details.html">
          ...
          <div class="col-6 col-md-4 col-lg-3">
            <div class="mb-3 product-card product-card_style3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                ...
                <div class="top-0 left-0 mx-2 mt-2 bg-white product-label text-uppercase">New</div>
              </div>
          ...
          <div class="col-6 col-md-4 col-lg-3">
            <div class="mb-3 product-card product-card_style3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                ...
                <div class="top-0 right-0 left-auto mx-2 mt-2 text-white product-label bg-red">-67%</div>
              </div>
