            ...
            <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{ route('admin.product.update') }}">
                ...
                <div class="wg-box">
                    ...
                    <fieldset class="name">
                        ...
                        <input class="mb-10" type="text" placeholder="Nom..." name="name" tabindex="0" value="{{ $product->name }}" aria-required="false">
                    ...
                    <fieldset class="name">
                        ...
                        <input class="mb-10" type="text" placeholder="Slug..." name="slug" tabindex="0" value="{{ $product->slug }}" aria-required="false">
                    ...
                    <fieldset class="shortdescription">
                        ...
                        <textarea class="mb-10 ht-150" name="short_description" placeholder="Courte description" tabindex="0" aria-required="false">{{ $product->short_description }}</textarea>
                    ...
                    <fieldset class="description">
                        ...
                        <textarea class="mb-10" name="description" placeholder="Description" tabindex="0" aria-required="false">{{ $product->description }}</textarea>
                        <div class="text-tiny">Ne pas dépasser 100 caractères lors de la saisie du nom du produit.</div>
                    </fieldset>
                    @error('description')
                        <span class="alert alert-danger text-center">{{ $message }}</span>
                ...
                <div class="wg-box">
                    ...
                    <div class="cols gap22">
                        ...
                        <fieldset class="name">
                            ...
                            <input
                                class="mb-10"
                                type="text"
                                placeholder="Entrer le prix régulier"
                                name="regular_price"
                                tabindex="0"
                        ...
                        <fieldset class="name">
                            ...
                            <div class="select mb-10">
                                <select class="" name="stock_status">
                                    ...
                                    <option value="outofstock" {{ $product->stock_status == 'outofstock' ? 'selected' : '' }}>En rupture de stock</option>
                                </select>
                            </div>
                        </fieldset>
                        @error('stock_status')
                    ...
                    <div class="cols gap10">
                        <button class="tf-button w-full" type="submit">Mettre a jour</button>
                    </div>
                </div>
            </form>
        </div>
