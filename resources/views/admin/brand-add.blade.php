    ...
    <div class="main-content-inner">
        <div class="main-content-wrap">
            <div class="flex flex-wrap items-center justify-between gap20 mb-27">
                <h3>Infomation sur la marque</h3>
            ...
            <div class="wg-box">
                <form class="form-new-product form-style-1" action="{{ route('admin.brand.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Brand name" name="name" tabindex="0" value="{{ old('name') }}" aria-required="false">
                    </fieldset>
                    @error('name') <span class="alert alert-danger text-center">{{ $message }}</span> @enderror
                    {{-- Brand Slug --}}
                    <fieldset class="name">
                        <div class="body-title">Slug la marque <span class="tf-color-1">*</span></div>
                        <input class="flex-grow" type="text" placeholder="Brand Slug" name="slug" tabindex="0" value="{{ old('slug') }}" aria-required="false">
                    </fieldset>
            ...
            */
            ...
            function StringToSlug(Text) {
                return Text.toLowerCase()
                    .replace(/[^\w]+/g, "-")   // supprime tous les caractères non alphanumériques et les remplace par rien
