...
<head>
    ...
    {{-- Une pile dans Blade est une liste ordonnée de blocs de code
    (souvent des scripts ou du CSS) qu’on peut remplir à différents
    endroits d’une vue ou de composants grâce à la directive //@push('nom de la pile')
    puis afficher tout ce qu’on a ajouté à un endroit précis. --}}
    @stack("styles")
</head>
<body class="body">
    <div id="wrapper">
                ...
                <div class="section-menu-left">
                    ...
                    <div class="box-logo">
                        <a href="index.html" id="site-logo-inner">
                            <img class="" alt="" src="{{ asset('assets/images/logo.png') }}">
                        </a>
                    ...
                    <div class="center">
                        <div class="center-item">
                            <div class="center-heading">Accueil principal</div>
                            <ul class="menu-list">
                                <li class="menu-item">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{ route('admin.brand.add') }}" class="">
                                                <div class="text">Nouvelle marque</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="sub-menu-item">
                                            <a href="order-tracking.html" class="">
                                                <div class="text">Suivi des commandes</div>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="menu-item">
                                    <form action="{{ route('logout') }}" method="POST" id="logout-form">
                                        ...
                                        <a href="#" class="" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                            <div class="icon"><i class="icon-settings"></i></div>
                                            <div class="text">Se Deconnecter</div>
                                        </a>
                                    </form>
                                </li>
                            </ul>
                                        ...
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-user wg-user">
                                                ...
                                                <span class="flex flex-column">
                                                    <span class="mb-2 body-title">Kristin Watson</span>
